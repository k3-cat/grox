/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: 7f71a1266f8cff31192bd99e54e446ba)
// Runtime types generated with workerd@1.20250803.0 2025-08-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV_UPDATE: KVNamespace;
		KV_CUBE: KVNamespace;
		GITHUB_PAT: string;
		R2_CUBE: R2Bucket;
		R2_STATIC: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_PAT">> {}
}
